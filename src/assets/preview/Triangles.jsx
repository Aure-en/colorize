  ...
  return (
    ...
    >
      <g transform="scale(4.672897196261682)">
        <rect x="0" y="0" width="428" height="642" fill={theme.background} />
        <rect x="0" y="0" width="107" height="107" fill={theme.background} />
        ...
        <rect x="214" y="0" width="107" height="107" fill={theme.background} />
        ...
        <rect x="321" y="0" width="107" height="107" fill={theme.background} />
        ...
        <rect x="0" y="107" width="107" height="107" fill={theme.background} />
        ...
        <rect x="107" y="107" width="107" height="107" fill={theme.background} />
        ...
        <rect x="214" y="107" width="107" height="107" fill={theme.background} />
        ...
        <rect x="0" y="214" width="107" height="107" fill={theme.background} />
        ...
        <rect x="107" y="321" width="107" height="107" fill={theme.background} />
        ...
        <rect x="214" y="321" width="107" height="107" fill={theme.background} />
        ...
        <rect x="107" y="428" width="107" height="107" fill={theme.background} />
        ...
        <rect x="321" y="428" width="107" height="107" fill={theme.background} />
        ...
        <rect x="107" y="535" width="107" height="107" fill={theme.background} />
